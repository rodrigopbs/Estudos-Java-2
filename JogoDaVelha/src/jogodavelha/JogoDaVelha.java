        ...
        while (!ganhou){
            ...
            while (!colunaValida){
                ...
                if (coluna >= 1 && coluna <=3){
                    ...
                    System.out.println("Entrada invpalida, tente novamente.");
                }
            }
           ...
           if ((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X') ||  //linha 1
               (jogoVelha[1][0] == 'X' && jogoVelha[1][2] == 'X' && jogoVelha[1][2] == 'X' ) || //linha 2
               (jogoVelha[2][0] == 'X' && jogoVelha[2][2] == 'X' && jogoVelha[2][2] == 'X' ) || //linha 3
            ...
            ganhou = true;
               ...
               (jogoVelha[1][0] == 'O' && jogoVelha[1][2] == 'O' && jogoVelha[1][2] == 'O' ) ||     //linha 2
               (jogoVelha[2][0] == 'O' && jogoVelha[2][2] == 'O' && jogoVelha[2][2] == 'O' ) ||     //linha 3
